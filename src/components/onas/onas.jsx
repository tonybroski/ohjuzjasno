    ...
    <div className="onas-style">
      <text className="onas-text">
        ...
        <p className="onas-pomysl-text">
          ...
          najważniejsze jest w jakiś sposób elektroniczne. Daty są zwykle
          dostępne również w innych miejscach w sieci, ale są bardzo
          fragmentaryczne. Aby uzyskać przegląd, musisz odwiedzać różne witryny,
          a tymczasem w większości być nawet użytkownikiem Facebooka. Często coś
          przeoczasz i dopiero później zdajesz sobie sprawę z tego, co
          przegapiłeś. Oczywiście są też inne portale, które gromadzą
          informacje, ale uważamy, że są one w większości nieporęczne i przede
          wszystkim raczej trudne niż w użyciu na telefonach komórkowych.
        ...
        <p className="onas-opinia-text">
          ...
          wszystkich. Przyglądamy się każdemu wpisowi, a następnie ręcznie
          publikujemy wydarzenie. Ale zawsze pamiętaj: Jesteśmy elektronicznym
          serwisem informacyjnym o tańcu - z nami na próżno będziesz szukać
          rocka, popu, best of RnB i tym podobnych. Jeśli ktoś nie chce oglądać
          swojego wydarzenia na naszej stronie, skontaktuj się z nami, a
          natychmiast usuniemy wydarzenie. Chciałbyś współpracować z OhJużJasno,
